...
from workflow_settings.models import File, Run, LabelSummary
...
class FileDownloadService:
    ...
    def download_annotated_dataset(self, run_id):
        ...
        if run_filter.exists():
            ...
            return None, status.HTTP_400_BAD_REQUEST, {"message": "A classifier must be trained for the download. Go to step 3."}
