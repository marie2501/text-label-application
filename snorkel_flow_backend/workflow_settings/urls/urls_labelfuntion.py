...
from workflow_settings.views.view_labelfunktion.view_labelfunction import LabelfunctionView
...
urlpatterns = [
    ...
    path('workflow/<int:workflow_id>/labelfunction/import/', LabelfunctionView.as_view({'get': 'get_imports'}), name='labelfunction_imports'),


    path('workflow/labelfunction/<int:labelfunction_id>/', LabelfunctionView.as_view({'get': 'get_labelfunction_by_id', 'delete': 'delete_labelfunction',
